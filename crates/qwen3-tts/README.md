...
MIT — see [LICENSE](LICENSE). Third-party material carried by this crate is
credited in [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md).

The licence covers **this crate's source only**. Qwen3-TTS model weights are
downloaded at runtime and carry their own terms — see the
